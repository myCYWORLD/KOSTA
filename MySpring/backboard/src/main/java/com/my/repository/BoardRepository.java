...
public interface BoardRepository {
	 ...
	 * 2)게시글 검색
	 * 3)게시글 상세보기  =>usecase에 대한 기능이고 db에 대한 기능은 sql 구문별로 메서드를 쪼개줘야함
	 * 조회수 1증가			
	 * 4)게시글 수정하기
	 * 5)게시글 삭제하기
	 * 6)답글쓰기
	...
	/**
	 * 검색어를 포함한 게시글 제목 또는 검색어를 포함한 게시자ID를 갖는 행 수를 검색한다
	 * @param word
	 * @return
	 * @throws FindException
	 */
	...
	/**
	 * 검색어를 포함한 게시글 제목 또는 검색어를 포함한 게시자ID를 갖는 게시글들을 검색한다
	 * @param word 검색어
	 * @param currentPage 검색할 페이지 번호
	 * @param cntPerPage 페이지별 보여줄 건수
	 * @return
