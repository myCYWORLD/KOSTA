...
@CrossOrigin(origins = "*") //* => 누구든지 접근 할 수 있다는 의미(같은 포트번호가 아닌 다른 포트번호에서도 접근 가능)
@RestController
...
//	}
	...
	public ResponseEntity<Object> modify(
			@PathVariable Long boardNo,@RequestBody Board b){
		try {
...
//		String loginedId = (String)session.getAttribute("loginInfo");
	...
	public void removeBoard(@PathVariable Long boardNo, Board board) throws RemoveException {
		try {
			String loginedId = "id1";
			board.getBoardId();
